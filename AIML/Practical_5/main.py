...
nx.draw(
    semantic_network, pos, with_labels=True, node_size=3000, font_size=9, arrows=True
)

# Display relationship labels
edge_labels = nx.get_edge_attributes(semantic_network, "relation")

nx.draw_networkx_edge_labels(
    semantic_network, pos, edge_labels=edge_labels, font_size=9
)
